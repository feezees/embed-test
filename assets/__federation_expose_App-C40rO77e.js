...
let saxios = axios.create({
  baseURL: DOMEN + "/api",
  // nextjs
  // baseURL: 'http://127.0.0.1:8080/api', // java spring
  // baseURL: 'http://127.0.0.1:5555/api', // go
  timeout: 2e3,
...
const {useState: useState$1,useRef,useEffect: useEffect$1,createContext,useMemo,useContext,useCallback} = React;


function useLoadGsiScript(options = {}) {
    const { nonce, locale, onScriptLoadSuccess, onScriptLoadError } = options;
    const [scriptLoadedSuccessfully, setScriptLoadedSuccessfully] = useState$1(false);
...
const Header = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-white flex-col items-center w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 w-full px-2 py-2 justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "logo" }),
        "catalog"
      ] }),
...
const Layout$1 = observer(Layout);

function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Hello World" }) });
}
const App$1 = observer(App);

export { GoogleOAuthProvider as G, App$1 as default, jsxRuntimeExports as j };
